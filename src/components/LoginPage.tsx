...
export function LoginPage({ onSignIn }: Props) {
  return (
    ...
    >
      ...
      <button
        onClick={onSignIn}
        className="flex items-center gap-3 px-6 py-4 rounded-2xl font-bold text-lg transition-transform hover:scale-105 active:scale-95 shadow-xl"
        style={{
          backgroundColor: '#fff',
          color: '#1a1a2e',
          boxShadow: `0 0 32px ${theme.accent}44`,
        }}
      >
        <GoogleIcon />
        Sign in with Google
